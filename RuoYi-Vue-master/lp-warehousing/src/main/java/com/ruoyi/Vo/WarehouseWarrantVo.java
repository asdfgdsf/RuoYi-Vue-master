...
public class WarehouseWarrantVo {
    ...
    public WarehouseWarrantVo() {
    }

    public WarehouseWarrantVo(Long warehouseWarrantId, Long auditStatus, String auditOpinion, Date auditTime, String auditPerson, String approverOpinion, Date approverTime, String approverPerson) {
    ...
    public String toString() {
        return "WarehouseWarrantVo{" +
                "warehouseWarrantId=" + warehouseWarrantId +
